            ...
            <div class="panel-body">
              ...
              <div class="loan_tenure">
                <div class="box-div">
                  ...
                  <div class="right-box">
                    <div class="input-container">
                      <input class="input-field" style="display:none;" id="textInputTenureMonth" type="number" name="rangeInput" min="1" onchange="updateRangeTenureMonth(this.value)">
                      <input class="input-field"  id="textInputTenure" type="number" name="rangeInput" min="1" onchange="updateRangeTenure(this.value)">
                      <a href="javascript:void(0)" onclick="changeYear()"><div class="icon selector" id="year">Yr.</div></a>
                      <a href="javascript:void(0)" onclick="changeMonth()"><div class="icon" id="month">Mo.</div></a>
                    </div>
                  </div>
                </div>
                <div class="range-div" id="monthRange" style="display:none;">
                ...
                <div class="range-div" id="yearRange">
                  <input type="range" name="rangeInput" id="rangeInputTenureYear" min="0" max="30" value="5" onchange="updateTextInputTenureYear(this.value);">
