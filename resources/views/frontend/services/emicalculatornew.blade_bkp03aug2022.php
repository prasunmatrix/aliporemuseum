            ...
            <div class="panel-body">
                ...
                <div class="box-div">
                  ...
                  <div class="right-box">
                    <div class="input-container">
                      <input class="input-field" id="textInputLoan" type="text" name="rangeInput">
                      <div class="icon">Rs.</div>
                    </div>
                  </div>
                </div>
                <div class="range-div">
                  <input type="range" name="rangeInput" id="rangeInputLoan" min="0" max="200000" onchange="updateTextInputLoan(this.value);">
                  <div id="loanamountsteps" class="steps"><span class="tick" style="left: 0%;">|<br><span class="marker">0</span></span><span class="tick d-none d-sm-table-cell" style="left: 12.5%;">|<br><span class="marker">25000</span></span><span class="tick" style="left: 25%;">|<br><span class="marker">50000</span></span><span class="tick d-none d-sm-table-cell" style="left: 37.5%;">|<br><span class="marker">75000</span></span><span class="tick" style="left: 50%;">|<br><span class="marker">100000</span></span><span class="tick d-none d-sm-table-cell" style="left: 62.5%;">|<br><span class="marker">125000</span></span><span class="tick" style="left: 75%;">|<br><span class="marker">150000</span></span><span class="tick d-none d-sm-table-cell" style="left: 87.5%;">|<br><span class="marker">175000</span></span><span class="tick" style="left: 100%;">|<br><span class="marker">200000</span></span></div>
                </div>
              </div>
              <div class="loan_rate">
                <div class="box-div">
                  ...
                  <div class="right-box">
                    <div class="input-container">
                      <input class="input-field" id="textInputRate" type="text" name="rangeInput">
                      <div class="icon">%</div>
                    </div>
                  </div>
                </div>
                <div class="range-div">
                  <input type="range" name="rangeInput" id="rangeInputInterest" min="5" max="20" onchange="updateTextInputRate(this.value);">
              ...
              <div class="loan_tenure">
                <div class="box-div">
                  ...
                  <div class="right-box">
                    <div class="input-container">
                      <input class="input-field" id="textInputTenure" type="text" name="rangeInput">
                ...
                <div class="range-div">
                  <input type="range" name="rangeInput" id="rangeInputTenure" min="0" max="30" onchange="updateTextInputTenure(this.value);">
          ...
          <div class="panel">
            <div class="panel-body">
              <div class="summary">
                ...
                <div class="summary_amt"><i class="fa fa-inr"></i> 40,280</div>
              </div>
              <div class="summary">
