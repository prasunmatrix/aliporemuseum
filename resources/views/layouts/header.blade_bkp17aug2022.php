            ...
            <div class="menu">
              <nav>
                <ul>
                  ...
                  <li @if(Route::currentRouteName()=='branch' || Route::currentRouteName()=='knowledge-corner' || Route::currentRouteName()=='event-calendar' || Route::currentRouteName()=='organisation-chart' || Route::currentRouteName()=='emi-calculator' || Route::currentRouteName()=='tender' || Route::currentRouteName()=='notice') class="active" @endif><a href="#">Services</a>
                    <ul>
