            ...
            <div class="menu">
              <nav>
                <ul>
                  ...
                  <li @if(Route::currentRouteName()=='organisation-chart' || Route::currentRouteName()=='about-us' ) class="active" @endif><a href="#">About Us </a>
                    <ul>
                      <li><a href="{{ url('organisation-chart') }}">Organisation Chart</a></li>
                      <li><a href="{{ url('about-us') }}">List of CEO</a></li>
                    </ul>
                  </li>
              ...
              <div id="hamburger-icon">
                ...
                <ul class="mobile-menu panel">
                  ...
                  <li @if(Route::currentRouteName()=='organisation-chart' || Route::currentRouteName()=='about-us' ) class="active" @endif><a href="javascript:void(0)" class="accordion">About Us </a>
                    <ul class="panel">
                      <li><a href="{{ url('organisation-chart') }}">Organisation Chart</a></li>
                      <li><a href="{{ url('about-us') }}">List of CEO</a></li>
                    </ul>
