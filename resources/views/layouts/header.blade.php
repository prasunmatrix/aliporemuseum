        ...
        <div class="menu">
          <nav>
            <ul>
              ...
              <li @if(Route::currentRouteName()=='organisation-chart' || Route::currentRouteName()=='about-us' || Route::currentRouteName()=='profile' || Route::currentRouteName()=='structure' || Route::currentRouteName()=='business' || Route::currentRouteName()=='technology' || Route::currentRouteName()=='why-rccb-ltd' || Route::currentRouteName()=='mission' ) class="active" @endif><a href="#">About Us </a>
                <ul>
                  <li><a href="{{ url('profile') }}">Profile</a></li>
                  <li><a href="{{ url('structure') }}">Structure</a></li>
                  <li><a href="{{ url('business') }}">Business</a></li>
                  <li><a href="{{ url('technology') }}">Technology</a></li>
                  <li><a href="{{ url('why-rccb-ltd') }}">Why RCCB Ltd</a></li>
                  <li><a href="{{ url('mission') }}">Mission</a></li>
                  <li><a href="{{ url('organisation-chart') }}">Organisation Chart</a></li>
                  <li><a href="{{ url('about-us') }}">Incumbency List for Chief Executive Officers</a></li>
                </ul>
              </li>
              <li @if(Route::currentRouteName()=='personal-loan' || Route::currentRouteName()=='home-loan' || Route::currentRouteName()=='car-loan' || Route::currentRouteName()=='eccs-loan' || Route::currentRouteName()=='cash-credit-loan' || Route::currentRouteName()=='savings-account' || Route::currentRouteName()=='current-account' ) class="active" @endif><a href="#">Products</a>
                <ul>
                  ...
                  <li><a href="#">Accounts</a>
                    <ul>
                      <li><a href="{{ url('savings-account') }}">Savings Account</a></li>
                      <li><a href="{{ url('current-account') }}">Current Account</a></li>
              ...
              <li @if(Route::currentRouteName()=='branch' || Route::currentRouteName()=='emi-calculator' || Route::currentRouteName()=='neft-rtgs' || Route::currentRouteName()=='safe-deposit' ) class="active" @endif><a href="#">Services</a>
                <ul>
                  ...
                  <li><a href="{{url('safe-deposit')}}">Safe Deposit Locker</a></li>
              ...
              <!-- <li><a href="https://www.wbcoopbanks.in/OnlineRCCBLT/" target="_blank">Internet Banking</a></li> -->
              <li @if(Route::currentRouteName()=='knowledge-corner' || Route::currentRouteName()=='event-calendar' || Route::currentRouteName()=='tender' || Route::currentRouteName()=='notice' ) class="active" @endif>
          ...
          <div id="hamburger-icon">
            ...
            <ul class="mobile-menu panel">
              ...
              <li @if(Route::currentRouteName()=='personal-loan' || Route::currentRouteName()=='home-loan' || Route::currentRouteName()=='car-loan' || Route::currentRouteName()=='eccs-loan' || Route::currentRouteName()=='cash-credit-loan' || Route::currentRouteName()=='savings-account' || Route::currentRouteName()=='current-account' ) class="active" @endif><a href="javascript:void(0)" class="accordion">Products</a>
                <ul class="panel">
                  <li><a href="javascript:void(0)">Loan & Advances</a>
                    <ul class="panel">
                      <!-- <li><a href="#">Agricultural Loan</a></li>
                      <li><a href="#">Loan to ECCS</a></li>
                      <li><a href="#">House Building Loans</a></li>
              ...
              <li @if(Route::currentRouteName()=='branch' || Route::currentRouteName()=='emi-calculator' || Route::currentRouteName()=='neft-rtgs' || Route::currentRouteName()=='safe-deposit' ) class="active" @endif><a href="javascript:void(0)" class="accordion">Services</a>
                <ul class="panel">
                  <li><a href="{{ url('branch') }}">Branch & ATM Locator</a></li>
                  <li><a href="{{ url('emi-calculator') }}">EMI Calculator</a></li>
                  <li><a href="{{ url('safe-deposit') }}">Safe Deposit Locker</a></li>
