        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              <span class="bg-info text-white">Partially Approved</span>
            ...
            <td> 
              @if($val->status=='partially approve')
              <a href="{{ url('employee/edit-hireleave',['encryptCode'=>encrypt($val->id, Config::get('Constant.ENC_KEY'))]) }}" class="btn btn-success"> Approve/Reject </a>
