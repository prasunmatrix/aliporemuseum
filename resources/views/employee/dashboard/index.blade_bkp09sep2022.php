    ...
    <div class="row">
        <div class="col-xl-3 col-md-6">
            <div class="card bg-primary text-white mb-4">
                <div class="card-body" style="text-align:center">Total Branch</div>
                <div style="text-align:center;font-size:50px;font-weight:bold">{{@$total_branch}}</div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-warning text-white mb-4">
                <div class="card-body" style="text-align:center">Total Tender</div>
                <div style="text-align:center;font-size:50px;font-weight:bold">{{@$total_tender}}</div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-success text-white mb-4">
                ...
                <div style="text-align:center;font-size:50px;font-weight:bold">{{@$total_user}}</div>
                <div class="card-footer d-flex align-items-center justify-content-between">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-danger text-white mb-4">
                ...
                <div style="text-align:center;font-size:50px;font-weight:bold">{{@$total_knowledge_corner}}</div>
