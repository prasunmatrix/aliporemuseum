    ...
    <script src="{{asset('assets/employee/js/scripts.js')}}"></script>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <!-- Summernote -->
    <script src="{{asset('assets/employee/plugins/summernote/summernote-lite.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.8.0/Chart.min.js" crossorigin="anonymous"></script>
    <script src="{{asset('assets/employee/demo/chart-area-demo.js')}}"></script>
    <script src="{{asset('assets/employee/demo/chart-bar-demo.js')}}"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
    <script src="{{asset('assets/employee/js/datatables-simple-demo.js')}}"></script>
