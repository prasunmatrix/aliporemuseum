...
class RoleController extends Controller
{
    ...
    {
       $this->middleware('permission:manage-role,admin', ['only' => ['index','store','create', 'edit','update', 'destroy']]);
    }
    ...
    {
        $this->data['page_title'] = 'Admin | Role';
        $this->data['role']= Role::orderBy('id','DESC')->paginate(5);
    ...
    {
        $this->data['page_title'] = 'Admin | Create Role';
    ...
    {
        $this->data['page_title'] = 'Admin | Role Edit';
