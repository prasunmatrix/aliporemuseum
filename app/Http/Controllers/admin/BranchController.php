...
class BranchController extends Controller
{
  ...
  public function store(Request $request)
  {
    ...
    $validator = Validator::make(
      ...
      [
        ...
        'branch_name'       => 'required|unique:branch_details,name_of_the_branch|string|max:200',
    ...
    if ($validator->fails()) {
      ...
      $atmid = $request->atmid;
      $atm_available = $request->atm_available == true ? '1' : '0';
  ...
  public function update(Request $request, $branch_id)
  {
    ...
    if ($validator->fails()) {
      ...
      $count = Branch::where('id', '!=', $branch_id)->where('name_of_the_branch', '=', $request->branch_name)->count();
      //dd($count);
      if ($count > 0) {
        $errMsg = array();
        $errMsg['errorbranch'] = 'The branch name has already been taken.';
        //dd($errMsg);
        return Redirect::back()
          ->withErrors($errMsg)
          ->withInput();
