  ...
  public function grievancePost(Request $request)
  {
    ...
    if ($validator->fails()) {
      ...
      if ($grievance != null) {
        ...
        $sendmails = array('dgmitrccbltd@gmail.com','kishor.rccbltd@gmail.com','agmactrccbltd@gmail.com');
        $data['email'] = $sendmails;
        $attchFile = public_path() . '/uploads/grievance/' . $file_name;
  ...
  public function feedbackPost(Request $request)
  {
    ...
    if ($validator->fails()) {
      ...
      if ($feedback != null) {
        ...
        $sendmails = array('dgmitrccbltd@gmail.com','kishor.rccbltd@gmail.com','agmactrccbltd@gmail.com');
        $data['email'] = $sendmails;
        $attchFile = public_path() . '/uploads/feedback/' . $file_name;
        $data['attchFile'] = $attchFile;
        if (!empty($filename)) {
